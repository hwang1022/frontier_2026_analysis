"""Table I: inclusive seven-day heat-window robustness."""
...
TABLE = "table_i_heat_window"
HEAT_SPECS = [
    ("tmean_7d_dev", r"7-day mean temperature"),
    ("hot30_7d_dev", r"Days above 30$^\circ$C"),
    ("heatwave_7d_dev", r"Local heatwave days"),
]
...
def main() -> None:
    ...
    body.extend(
        [
            ...
            r"Kecamatan + Month + Year FE & Yes & Yes & Yes & Yes \\",
