...
# Each collaborator maps their machine login to their own GEE Cloud project.
_GEE_PROJECTS_BY_USER = {
    "ew": "ugg-embedding",
    "simon": "vip-inc-vol-anal",
}
GEE_PROEJCT_ID = _GEE_PROJECTS_BY_USER.get(getpass.getuser())
